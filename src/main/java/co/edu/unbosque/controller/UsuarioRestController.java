...
public class UsuarioRestController {
    ...
    public ResponseEntity<Boolean> existePorCorreo(
            @PathVariable("correo") String correoUsuario) {
        try {
            List<Usuario> usuarios = usuarioServiceAPI.getAll();
            boolean existe = usuarios.stream()
                .anyMatch(u -> u.getCorreoUsuario() != null && 
                             u.getCorreoUsuario().equalsIgnoreCase(correoUsuario));
        ...
        try {
            ...
            try {
                ...
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                       .body("Error al procesar credenciales");
            }
	...
	public ResponseEntity<String> forzarCambioClave(@PathVariable Long id, @RequestBody String nuevaClave) {
		...
		usuario.setClaveUsrio(nuevaClave);
    ...
    public ResponseEntity<Map<String, String>> generateCredentials(
